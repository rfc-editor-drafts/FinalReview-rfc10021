...
* The Pairwise Sender/Recipient Keys defined in {{sec-derivation-pairwise}} of this document are used for the encryption and decryption process, instead of the Sender/Recipient keys.
