...
2. The Group Manager MUST build a set of stale Sender IDs, including:
   ...
   - The Sender IDs that, since the latest assignment of the current Gid to the group, were both already/newly assigned to an endpoint and subsequently relinquished (see {{new-sender-id}}).
