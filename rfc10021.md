...
In case block-wise transfer {{RFC7959}} is used, the same considerations from {{Section 10.3 of RFC9594}} apply.
...
* OSCORE groups G1 and G2, with ID Context (GID) GID1 and GID2, respectively. Both G1 and G2 use the AEAD cipher AES-CCM-16-64-128, i.e., the MAC of the ciphertext is 8 bytes in size.
