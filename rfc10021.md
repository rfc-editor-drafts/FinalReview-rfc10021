...
| is incremented by 1        |            * After changing the Group ID,
|                            |              an unused kid can be
+----------------------------+              assigned even if it was used
                                            before the Group ID change
~~~~~~~~~~~
...
* OSCORE groups G1 and G2, with ID Context (Group ID) Gid1 and Gid2, respectively. Both G1 and G2 use the AEAD cipher AES-CCM-16-64-128, i.e., the MAC of the ciphertext is 8 bytes in size.
